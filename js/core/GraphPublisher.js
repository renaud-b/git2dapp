var GraphPublisher = {
    ...
    _finalize: function (filesSource, userAddress, doneMessage, continueButton) {
        var projectFiles = filesSource.map(function (projectFile) {
            ...
            var type = null;
            if (projectFile.file.path.endsWith(".html")) type = "text/html";
            else if (projectFile.file.path.endsWith(".css")) type = "text/css";
            else if (projectFile.file.path.endsWith(".js")) type = "text/javascript";
            return {
                name: projectFile.file.path,
                type: type,
                id: fileID
            };
        });
